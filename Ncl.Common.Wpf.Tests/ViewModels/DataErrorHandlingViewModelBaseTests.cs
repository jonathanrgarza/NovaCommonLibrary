...
namespace Ncl.Common.Wpf.Tests.ViewModels
{
    ...
    public class GenericDataErrorHandlingViewModelBaseTests
    {
        private const string PropertyName = "testProperty";
        private const string SecondPropertyName = "testProperty2";
        private const string DefaultErrorMessage = "test error";
        ...
        public void AddError_WithNullErrorMessage_ShouldThrowArgumentNullException()
        {
            ...
            //Assert
            Assert.Throws<ArgumentNullException>("errorObject", TestCode);
        }
        ...
        public void AddErrors_WithNullErrorEnumerable_ShouldThrowArgumentNullException()
        {
            ...
            //Assert
            Assert.Throws<ArgumentNullException>("errorObjects", TestCode);
        }
        ...
        private static GenericDataErrorHandlingViewModelBaseMock GetDefaultInstance()
        {
            return new GenericDataErrorHandlingViewModelBaseMock();
        }

        /// <summary>
        ///     Mock implementation of <see cref="DataErrorHandlingViewModelBase" /> to allow unit testing.
        /// </summary>
        private class GenericDataErrorHandlingViewModelBaseMock : DataErrorHandlingViewModelBase<string>
        {
            /// <summary>
            ...
            ///     <paramref name="propertyName" /> is empty.
            /// </exception>
            public void AddErrorImpl(string propertyName, string errorObject)
            {
                AddError(propertyName, errorObject);
            }

            /// <summary>
            ///     Adds error for a given property.
            /// </summary>
            /// <param name="propertyName">The property's name.</param>
            ...
            ///     <paramref name="propertyName" /> is empty.
            /// </exception>
            public void AddErrorsImpl(string propertyName, IEnumerable<string> errorObjects)
            {
                AddErrors(propertyName, errorObjects);
            }
            ...
            ///     <paramref name="propertyName" /> is empty.
            /// </exception>
            public bool RemoveErrorImpl(string propertyName, string errorObject)
            {
                return RemoveError(propertyName, errorObject);
            }
            ...
            ///     <paramref name="propertyName" /> is empty.
            /// </exception>
            public void ReplaceErrorsImpl(string propertyName, string errorObject)
            {
                ReplaceErrors(propertyName, errorObject);
            }
            ...
            ///     <paramref name="propertyName" /> is empty.
            /// </exception>
            public void ReplaceErrorsImpl(string propertyName, IEnumerable<string> errorObjects)
            {
                ReplaceErrors(propertyName, errorObjects);
            }
            ...
            /// <summary>
            ///     Clears/Removes all the error for the view model.
            /// </summary>
            public void ClearAllErrorsImpl()
            {
                ClearAllErrors();
