...
{
    /// <summary>
    ///     Interface for a simple preference service that does not require customizations.
    /// </summary>
    ...
    /// <summary>
    ///     Interface for a preference service.
    /// </summary>
    public interface IPreferenceService
    {
        ...
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     .NET Framework and .NET Core versions older than 2.1: <paramref name="directoryPath" /> is a zero-length string,
